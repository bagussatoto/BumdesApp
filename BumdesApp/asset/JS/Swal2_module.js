! function(t, e) {
    ...
    var st, ut = function(t, e) {
        ...
        mt = function(t) {
            var e, n = !!(e = W()) && (e.parentNode.removeChild(e), lt([document.documentElement, document.body], [F["no-backdrop"], F["toast-shown"], F["has-column"]]), !0);
    ...
    function Tt(t, s) {
        ...
        l >= s.progressSteps.length && D("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), s.progressSteps.forEach(function(t, e) {
            var n, o, i, r, a = (n = t, o = document.createElement("li"), ut(o, F["progress-step"]), M(o, n), o);
    ...
    var Qe, $e = function(t) {
        ...
        Je = Object.freeze({
            ...
            _main: function(t) {
                ...
                return qt(this, e), Ct.innerParams.set(this, e),
                    function(n, o, i) {
                        return new Promise(function(t) {
                            var e = function t(e) {
                                n.closePopup({
    ...
    }), Xe.DismissReason = _, Xe.version = "9.10.10";
    var Ge = Xe;
