...
! function(a, b) {
    ...
    var Vd = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,/*
        ...
        Wd = "Januari_Februari_Maret_April_Mei_Juni_Juli_Agustus_September_Oktober_November_Desember".split("_"),
        Xd = "Jan_Feb_Mar_Apr_Mei_Jun_Jul_Agu_Sep_Okt_Nov_Des".split("_"),
        Yd = Jd,
        Zd = Jd,
    ...
    var qe = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
        ...
        re = "Min_Sen_Sel_Rab_Kam_Jum_Sab".split("_"),
        se = "Mg_Sn_Sl_Rb_Km_Jm_Sb".split("_"),
        te = Jd,
        ue = Jd,
        ve = Jd;
