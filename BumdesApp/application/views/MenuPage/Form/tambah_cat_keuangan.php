                    ...
                    <form action="set-arus-kas" id="set-arus-kas" method="POST" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-3 text-center">
                          <input checked type="radio" name="jenis" value="IN" class="kas">
                          <label for="">Kas masuk (debit)</label>
                        </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3" >Pengecualian</label>
