    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
            <h1>Daftar harga sewa aset</h1>
              <div class="clearfix"></div>
            </div>
            <div class="x_content">
              <div class="row">
                <!-- <div class="col-md-3">
                  <a href="unduh-harga-sewa" class="btn btn-md btn-warning" target="_blank">Unduh daftar harga</a>
                </div> -->
                <div class="col-md-3">
                  <a href="tambah-aset-sewa" class="btn btn-md btn-info">Tambah aset sewa</a>
                </div>
              </div>
            </div>
          </div>
